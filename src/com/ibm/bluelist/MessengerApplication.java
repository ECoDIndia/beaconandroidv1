...
public final class MessengerApplication extends Application {
	...
	private static final String CLASS_NAME = MessengerApplication.class.getSimpleName();
	private static final String APP_ID = "applicationID";
	private static final String APP_SECRET = "applicationSecret";
	private static final String APP_ROUTE = "applicationRoute";
	private static final String PROPS_FILE = "beaconpush.properties";
	...
	public void onCreate() {
		...
		try {
			...
			Log.e(CLASS_NAME, "The beaconpush.properties file was not found.", e);
		} catch (IOException e) {
			Log.e(CLASS_NAME, "The beaconpush.properties file could not be read properly.", e);
		}
